               ...
               <div class="carousel-item active">
                  <div class="container">
                     <div class="banner_taital_main">
                        <div class="row">
                           <div class="col-md-6">
                              <h1 class="banner_taital">COS Educations Coachings</h1>
                              ...
                              <div class="btn_main">
                                 ...
                                 <div class="quote_bt"><a href="{{ route('login') }}">Get Started</a></div>
                              </div>
                           </div>
                           <div class="col-md-6">
         ...
         <div class="container">
            ...
            <div class="services_section_2">
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="image_main">
                        <img src="{{asset('assets/images/img-4.png')}}" class="image_8" style="width:100%">
                        <div class="text_main">
         ...
         <div class="container">
            ...
            <div class="news_section_2">
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <img src="{{asset('assets/images/img-6.png')}}" class="image_6" style="width:100%">
                  ...
                  <div class="container">
                     ...
                     <div class="client_section_2">
                        <div class="client_left">
                           <div><img src="{{asset('assets/images/client-img.png')}}" class="client_img"></div>
                        </div>
